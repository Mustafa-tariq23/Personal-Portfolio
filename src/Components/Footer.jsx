      ...
      <div className="container px-6 py-8 mx-auto">
        ...
        <div className="flex flex-col items-center sm:flex-row sm:justify-between">
          ...
          <div className="flex -mx-2">
            ...
            <a href="https://www.facebook.com/mustafa.tariq.583" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Facebook">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <a href="https://github.com/Mustafa-tariq23" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Github">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
